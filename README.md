...
* Engage with other users and developers on [MAKE Slack](https://MAKE.io/slack/).
* Join to our [gitter](https://gitter.im/MAKE-developers/Lobby).
...
MAKE Desktop is licensed under the MIT License - see the [LICENSE](./LICENSE) file for details.
